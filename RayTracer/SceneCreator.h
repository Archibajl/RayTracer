...
// Build voxel grid directly from stl_reader::StlMesh (no file I/O)
template <typename TNumber, typename TIndex>
VoxelGrid BuildVoxelGridFromStlReaderMesh(const stl_reader::StlMesh<TNumber, TIndex>& stlMesh, size_t nx, size_t ny, size_t nz);
